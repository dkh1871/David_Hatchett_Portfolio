...
## Contact: 
- E-mail: [dkh1871@gmail.com](mailto:dkh1871@gmail.com)  
## Technical Skills

**Data & Analytics:**  
ETL, Data cleaning, Data analysis, Data visualization, Data storytelling, Data engineering, Data mining, Data modeling, Data governance, Metric development, Feature preparation

**Database:**  
SQL Server, Snowflake, SQLite, Teradata

**Programming Languages:**  
Python, SQL, VBA

**Python ecosystem:**  
pandas, PyTorch, sklearn, Matplotlib, Conda

**Visualizations:**  
Tableau

**Distributed Computing (Foundational):**  
Spark, YARN, HDFS, Hive, Hbase, Nifi, Kafka, Sofi
...
## [Heart Disease Model Testing](https://github.com/dkh1871/Heart_Disease_Model_Testing) 
Working with a dataset created on Kaggle to test three different classification models and see how well the models perform.  

## [Video Game Completion and Speed Run Times](https://github.com/dkh1871/Video_Game_Completion_and_Speed_Run_Times/tree/main)  
